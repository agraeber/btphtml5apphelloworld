		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hello World AGR",
									"targetURL": "#jungheinrichsbxhelloworldui5agr-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"jungheinrichsbxhelloworldui5agr-display": {
								"semanticObject": "jungheinrichsbxhelloworldui5agr",
								"action": "display",
								"description": "A Fiori Hello World AGR application.",
								"title": "Hello World AGR",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=jungheinrich.sbx.helloworldui5agr",
									"url": sap.ui.require.toUrl("jungheinrich/sbx/helloworldui5agr")
								}
							}
						}
					}
